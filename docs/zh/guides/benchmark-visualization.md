...
<div style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-border); border-radius: 12px; padding: 24px; margin: 24px 0;">
  ...
  <div style="display: flex; justify-content: center; gap: 24px; margin-top: 16px; font-size: 13px;">
    <div style="display: flex; align-items: center; gap: 6px;">
      ...
      <span style="color: var(--vp-c-text-2);">融合（本仓库）</span>
    </div>
    <div style="display: flex; align-items: center; gap: 6px;">
      <div style="width: 14px; height: 14px; background: #30363d; border-radius: 3px;"></div>
      <span style="color: var(--vp-c-text-2);">未融合（PyTorch）</span>
    </div>
  </div>
  <p style="text-align: center; font-size: 12px; color: var(--vp-c-text-3); margin-top: 8px;">Sequence Length &mdash; Latency (&micro;s)，batch=2，hidden_dim=4096</p>
</div>
...
<div style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-border); border-radius: 12px; padding: 24px; margin: 24px 0;">
  ...
  <p style="text-align: center; font-size: 12px; color: var(--vp-c-text-3); margin-top: 8px;">Batch Size &mdash; 加速比 (`fused_rmsnorm_rope`, seq_len=2048)</p>
</div>
...
<div style="background: var(--vp-c-bg-soft); border: 1px solid var(--vp-c-border); border-radius: 12px; padding: 24px; margin: 24px 0;">
  <div style="display: flex; justify-content: center; gap: 60px; align-items: flex-end; height: 240px; padding-bottom: 40px; border-bottom: 1px solid var(--vp-c-border);">
    ...
    <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
      ...
      <span style="font-size: 13px; color: var(--vp-c-text-2); font-weight: 600; margin-top: 8px;">融合</span>
    </div>
    ...
    <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
      ...
      <span style="font-size: 13px; color: var(--vp-c-text-2); font-weight: 600; margin-top: 8px;">未融合</span>
    </div>
  ...
  <p style="text-align: center; font-size: 12px; color: var(--vp-c-text-3); margin-top: 8px;">单次前向内存流量对比 (`fused_rmsnorm_rope`, batch=2, seq_len=2048)</p>
</div>
